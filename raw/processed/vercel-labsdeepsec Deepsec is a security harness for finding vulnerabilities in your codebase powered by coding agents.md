...
If you feel like the `deepsec` should look at more parts of the code, give it [the writing matchers](https://github.com/vercel-labs/deepsec/blob/main/docs/writing-matchers.md) doc to find more valuable starting points in your code base.

## Docs

- [docs/getting-started.md](https://github.com/vercel-labs/deepsec/blob/main/docs/getting-started.md) — first-scan walkthrough
- [docs/reviewing-changes.md](https://github.com/vercel-labs/deepsec/blob/main/docs/reviewing-changes.md) — `process --diff` for PR review and CI gating
- [docs/supported-tech.md](https://github.com/vercel-labs/deepsec/blob/main/docs/supported-tech.md) — frameworks and ecosystems deepsec recognizes out of the box
- [docs/writing-matchers.md](https://github.com/vercel-labs/deepsec/blob/main/docs/writing-matchers.md) — **prompt your coding agent to grow your matcher set**
- [docs/configuration.md](https://github.com/vercel-labs/deepsec/blob/main/docs/configuration.md) — `deepsec.config.ts` reference
- [docs/plugins.md](https://github.com/vercel-labs/deepsec/blob/main/docs/plugins.md) — plugin authoring
- [docs/models.md](https://github.com/vercel-labs/deepsec/blob/main/docs/models.md) — model selection, defaults, refusals, future models
- [docs/vercel-setup.md](https://github.com/vercel-labs/deepsec/blob/main/docs/vercel-setup.md) — AI Gateway + Vercel Sandbox keys / tokens
- [docs/architecture.md](https://github.com/vercel-labs/deepsec/blob/main/docs/architecture.md) — pipeline internals
- [docs/data-layout.md](https://github.com/vercel-labs/deepsec/blob/main/docs/data-layout.md) — `data/` schemas (FileRecord, RunMeta, …)
- [docs/faq.md](https://github.com/vercel-labs/deepsec/blob/main/docs/faq.md) — cost, model choice, sandbox mode, FP rate
- [samples/](https://github.com/vercel-labs/deepsec/blob/main/samples) — copy-paste starting points (currently: `webapp/`)
- [CONTRIBUTING.md](https://github.com/vercel-labs/deepsec/blob/main/CONTRIBUTING.md) — repo layout, dev workflow
...
See [docs/vercel-setup.md](https://github.com/vercel-labs/deepsec/blob/main/docs/vercel-setup.md) for getting a key and for the Vercel Sandbox setup. To bypass the gateway, set `ANTHROPIC_AUTH_TOKEN` + `ANTHROPIC_BASE_URL` (or the OpenAI pair) explicitly. Explicit values always win over the `AI_GATEWAY_API_KEY` expansion.
...
Needs a Vercel account. The local working tree is tarballed and uploaded; `.git` is excluded. Both OIDC tokens (local) and access tokens (CI) are supported — see [docs/vercel-setup.md](https://github.com/vercel-labs/deepsec/blob/main/docs/vercel-setup.md).
