...
!['F' logo on a watercolor background](https://mintcdn.com/fastmcp/xdeorzy2A8w9kCCa/assets/brand/f-watercolor-waves.png?w=2500&fit=max&auto=format&n=xdeorzy2A8w9kCCa&q=85&s=6f84b20c8d1f1ab62bc4e88b47d70e6f)
...
Ready to build? Start with our [installation guide](https://gofastmcp.com/v2/getting-started/installation) or jump straight to the [quickstart](https://gofastmcp.com/v2/getting-started/quickstart).
