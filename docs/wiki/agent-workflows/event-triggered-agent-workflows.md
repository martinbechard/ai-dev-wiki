...
The September 6 raw sources add wake-on-change, incident, and production-action evidence. The [leaf update watch source](../../../raw/processed/2026-09-06/ai-dev-wiki-leaf-update-watch-2026-09-06T210256-0400.json) and [topic news collector source](../../../raw/processed/2026-09-06/ai-dev-wiki-topic-news-collector-2026-09-07T003131Z.json) support treating recurring triggers as observable contracts before they can act beyond observation.

The [September 1 topic news collector source](../../../raw/processed/2026-09-01/ai-dev-wiki-topic-news-collector-2026-09-02T003202Z.json) adds three supervisory automation patterns: runtime cooldowns and stop-after expressions for limiting workflow execution, a PR drift monitor that posts a coding-agent request only when a targeted nudge is warranted, and an issue hierarchy workflow that records declined clusters when confidence is too low. Locally, event-triggered agents should keep trigger rate limits, stop conditions, drift evidence, nudge criteria, safe-output counts, grader results, and abstention logs with the run record.
...
- Preserve watched-object identity, incident or escalation log, and task-completion state when wake-on-change triggers can act.
- Require production authorization evidence before critical-risk triggers move from observation to mutation.
- Preserve cooldown, stop-after, drift-detection, targeted-nudge, safe-output, grader, and abstention-log evidence when monitors decide whether to wake or mutate coding work.
...
- Maintained on 2026-09-06 with wake-on-change, incident-log, task-completion, critical-risk, production-authorization, and escalation evidence.
- Maintained on 2026-09-01 with cooldown, stop-after, PR drift monitor, targeted nudge, safe-output grading, and issue-abstention evidence.
