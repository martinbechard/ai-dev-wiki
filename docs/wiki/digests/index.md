...
The [current September digest](2026-09.md) includes September 5 practice updates for MCP gateways, data governance, human checkpoints, cloud workspaces, spec and instruction layers, review loops, and model-routing criteria.
